...
//    public User user;
    ...
    public String index(Model model, HttpServletRequest request, HttpServletResponse response){
        ...
        String jsonData = SendGET("https://www.sojson.com/open/api/weather/json.shtml?city=苏州");
...
//        String weather = jso.getJSONObject("weatherinfo").getString("weather");
            if (jso!= null && jso.getJSONObject("data") != null) {
                String wendu = jso.getJSONObject("data").getString("wendu");
                String type = jso.getJSONObject("data").getJSONObject("forecast").getString("type");
                String low_temp = jso.getJSONObject("data").getJSONObject("forecast").getString("low");
                String high_temp = jso.getJSONObject("data").getJSONObject("forecast").getString("high");
//        String high_temp = jso.getJSONObject("weatherinfo").getString("temp2");
//                System.out.println(low_temp.substring(3, 7) + "0000" + high_temp + "))" + wendu + "888" + type);
                model.addAttribute("low_temp", low_temp.substring(3));
                model.addAttribute("high_temp", high_temp.substring(3));
