                            ...
                            <li class="course-one" data-courseid="725" data-uid="6362103">
                                <div class="course-list-img l">
                                    <a href="${base}/chapter/listChapter?id=${showUserCourseList[userCourse_index].id}" target="_blank">
                                        <img width="200" height="113" alt="" src="${base}/upload/${showUserCourseList[userCourse_index].filePath}">
                                    </a>
                                </div>
                                <div class="course-list-cont">
                                    ...
                                    <div class="catog-points">
                                        ...
                                        <span class="i-right span-common"><a href="#">问答0<i></i></a></span>

                                        <a href="${base}/chapter/listChapter?id=${showUserCourseList[userCourse_index].id}" target="_blank" class="btn-red continute-btn">继续学习</a>
