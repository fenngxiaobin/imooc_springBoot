...
<head>
    ...
    <link rel="stylesheet" href="${base}/front/css/danmuplayer.css">
...
//        console.log(headimg);
        ...
        var text= "                              <div class=\"pl-list-avator\">"+
                ...
                "                                        <img src=\"/upload/\" title=\"zsail\" width=\"40\" height=\"40\">"+
                "                                    </a>"+
                "                                </div>"+
                        ...
                        <div class="card-inner">
                            <div class="card-top clearfix">
                                ...
                                <div class="card-top-right-box l">
                                    ...
                                    <div class="meta">
                                        <a href="">经验<b id="js-user-mp">1,243</b>
                                        </a>
                                        <a href="">积分<b id="js-user-credit">0</b>
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<div class="course-subcontainer clearfix">
    <div class="course-left">
        <ul id="myTab" class="course-menu course-video-menu clearfix js-course-menu">
            <li class="active"><a href="#comment" data-toggle="tab" id="plMenu" onclick="choose4()" style="color:#00b43c ">评论</a></li>
            <li ><a href="#qa" data-toggle="tab" id="qaMenu" onclick="choose5()">问答</a></li>
        </ul>
                ...
                <div class="publish clearfix" id="discus-publish">
                    <div class="publish-wrap publish-wrap-pl">
                        <div class="pl-input-wrap clearfix">
                            <div class="pl-input-box clearfix" style="margin-top: 20px">
                                <a href="" class="user-head l">
                                    <img src="<#if "${(userFront.id)!}"=="">${base}/upload/head.jpg<#else>${base}/upload/${(userFront.headimg)!}</#if>" />
                                </a>
                    ...
                    <div class="pl-container" id = "comments-container">
                        ...
                        <#list commentList as comment>
                            <li class="pl-list clearfix">
                                <div class="pl-list-avator">
                                    <a href="https://www.imooc.com/u/3936322/courses" target="_blank">
                                        <img src="${base}/upload/${(comment.user.headimg)!}" title="${(comment.user.username)!}" width="40" height="40">
                                    </a>
                                </div>
                                <div class="pl-list-main">
                                    <div class="pl-list-nick">
                                ...
                                <div class="answertabcon">
                                    <div class="wenda-listcon clearfix">
                                        <div class="headslider l">
                                            <a href="${base}/mycenter/myprofile" class="wenda-head" target="_blank" title="${qa.user.username}">
                                                <img src="${base}/upload/${qa.user.headimg}" alt="${qa.user.username}" width="40">
                                                <i class="icon-ques-revert nofinish"></i>
                                            </a>
                                        </div>
                                        <div class="wendaslider">
                                            <h2 class="wendaquetitle">
                                                <a href="${base}/mycenter/myprofile" target="_blank" title="${qa.user.username}" class="wenda-nickname">${qa.user.username}
                                                </a>
                                                <div class="wendatitlecon">
                                                    <a href="${base}/qa/qaView?id=${qa.id}" target="_blank" class="wendatitle">
                                                        <b> ${qa.title}  </b>
                                                    </a>
                                                    <br>
                    ...
                    <#list courseList as course>
                        <li class="clearfix">
                            <a href="https://coding.imooc.com/class/186.html" class="clearfix" target="_blank">
                                <div class="l course-img" style="background-image: url(${base}/upload/${(course.filePath)!});">
                                    <div class="cart-color red"></div>
                                </div>
                                <div class="l content-box">
                                    <p class="smalle-title">${course.courseName}</p>
...
<script>
    function choose4() {
        document.getElementById("plMenu").style.color = "#00b43c";
        document.getElementById("qaMenu").style.color = "#4d555d";
    }
    function choose5() {
        document.getElementById("qaMenu").style.color = "#00b43c";
        document.getElementById("plMenu").style.color = "#4d555d";
    }
</script>
...
<script src="${base}/front/js/video/jquery.shCircleLoader.js"></script>
<script src="${base}/front/js/video/sco.tooltip.js"></script>
<script src="${base}/front/js/video/colpick.js"></script>
<script src="${base}/front/js/video/jquery.danmu.js"></script>
<script src="${base}/front/js/video/main.js"></script>

<script>
//    var post
    $("#danmup").DanmuPlayer({
        src:"${base}/upload/${(video.filePath)!}",
        height: "420px", //区域的高度
        width: "100%" //区域的宽度
        ,urlToGetDanmu:"/bullet/findByVideoId?videoId=${video.id}"
        ,urlToPostDanmu:"/bullet/addBulletScreen?videoId=${video.id}"
    });
    // var myPlayer = videojs("danmu-video");
    var myPlayer =  $(" .danmu-video").get(0);
    ...
    // var myPlayer = document.getElementByName("danmu-video");
    ...
    window.onbeforeunload = function(event) {
        ...
        if(userId != 0){
            ...
            $.ajax({
                type: "POST",
                url: "/vp/addRecord",
                data:{progress:myPlayer.currentTime,videoId:videoId1,userId:userId1,courseId:courseId},
                success:function(data){
                    if(data == "success"){
                    }
                },
...
//        setTimeout(function () {
//
//            var whereYouAt = parseInt(myPlayer.currentTime);//获取播放进度：
//            // myPlayer.currentTime(120);//设置播放进度：
//            // document.getElementById("p2").value= whereYouAt;
//            document.getElementById("p2").innerText = whereYouAt;
//            // alert(whereYouAt);
//            getvideoprogress();
//        }, 50);
//    }
