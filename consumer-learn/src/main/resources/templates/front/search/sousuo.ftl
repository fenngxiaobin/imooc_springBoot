    ...
    <div class="search-main">
        <div class="search-header">
            <form class="search_pos" name="sousuo" action="${base}/search/course">
                <div class="search-form">
                    ...
                    <input type="text" class="search-form-ipt js-search-ipt" value="${text}" name="words" placeholder="请输入想搜索的内容">
        ...
        <div class="search-body">
            <div class="search-content">
                ...
                <#else >
                    <span class="search-related">共找到0个相关内容</span>
                </#if>
            ...
            <#if searchCourseList??>
                <#list searchCourseList as course>
                    <div class="course-item">
                        <a href="${base}/chapter/listChapter?id=${course.id}" target="_blank" class="course-detail-title">
                            <img src="${base}/upload/${course.filePath}" target="_blank">
                        </a>
                        ...
                        <div class="course-item-detail">
                            ...
                            <div class="course-item-classify">
                                ...
                                <span>讲师：
									<a class="course-tname" target="_blank" href="">${userNameList[key]}</a>
								</span>
                                <span>
                                    等级：${course.level}
								</span>
