                    ...
                    <div class="course-card-container">
                        <a target="_blank" href="${base}/chapter/listChapter?id=${course.id}" class="course-card">
                            ...
                            <div class="course-card-top">
                                <img class="course-banner lazy" data-original="//img4.mukewang.com/5a9371160001ecb106000338-240-135.jpg" src="${base}/upload/${(course.filePath)!}" style="display: inline;">
