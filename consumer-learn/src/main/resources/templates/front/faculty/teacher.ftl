            ...
            <div class="top-bg-mask">
                <div class="top-content-wrap">
                    ...
                    <div class="teacher-box">
                        <div class="teacher-info">
                            <div class="teacher-info-image" style="background-image: url(${base}/upload/${(lecture.headimg)!});"></div>
                            <div class="tea-title">
                                <p>Hi课网官方认证</p>
                                <h3 style="font-family:Arial;color: #2b2b2b">精英讲师</h3>
                            </div>
                        </div>
                        <p class="tea-nickname">${lecture.username}</p>
                        <p class="tea-professional">${(lecture.position)!}</p>

                        <#if "${(userFront.id)!}"=="">
                            <a onclick="alert('登录了之后才能关注讲师！')" class="moco-btn payattention-btn js-payattention-btn js-add-attention" data-id="5634820">
                        ...
                        <#else>
                            <#if attentionList?exists>
                                ...
                                <#list attentionList as attention>
                                    <#if attention.user2.id == lecture.id>
                                        <a onclick="alert('您已经关注过这位讲师了！')" class="moco-btn payattention-btn js-payattention-btn js-add-attention" data-id="5634820">
                                            <i class="icon-heart4" style="color: grey"></i>
                                            已关注
                                        </a>
                                        <a onclick="deleteAttention(${lecture.id})" class="moco-btn payattention-btn js-payattention-btn js-add-attention" data-id="5634820">
                                            <i class="icon-heart4" style="color: grey"></i>
                                            取消关注
                                        </a>
                                        <#break>
                                ...
                                <#if count gt attentionList?size>
                                    <a onclick="addAttention(${lecture.id})" class="moco-btn payattention-btn js-payattention-btn js-add-attention" data-id="5634820">
                                        <i class="icon-heart4" style="color: red"></i>
                                        关注Ta
                                    </a>
                                </#if>
            ...
            <div class="shizhan-box">
                ...
                <div class="shizhan-del-box">
                    ...
                    <#list courseList?sort_by("score")?reverse as course>
                        <#assign count = count +1 />
                        <#if count <= 2>
                        <li style="background-image: url(${base}/upload/${course.filePath}); ">
