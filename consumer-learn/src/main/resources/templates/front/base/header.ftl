                        ...
                        <div class="person_expand">
                            <div class="table">
                                ...
                                <div class="tr">
                                    ...
                                    <#--<li>-->
                                        <#--<a href="#"><img width="40px" height="40px" src="${base}/admin/upload/${(userFront.headimg)!}"></a>-->
                                    <#--</li>-->
                                    <#--<li>-->
                                        <#--<a href="#">${(userFront.username)!}</a>-->
                                    <#--</li>-->
                                    <#--<li>-->
                                        <#--<#if "${(userFront.introduction)!}"!="">-->
                                            <#--<a href="#">${(userFront.introduction)!}</a>-->
                                            <#--<#else>-->
                                            <#--<a href="${base}/mycenter/myprofile"><span><i class="icon-pen2"></i>点击编辑个性签名</span></a>-->
                                        <#--</#if>-->
                                    <#--</li>-->
                                    <#--<li>-->
                                        <#--<a href="#"><span>更改头像框</span></a>-->
                                    <#--</li>-->
                                    <#--<li>-->
                                        <#--<a href="#"><span>您的积分：</span></a>-->
                                    <#--</li>-->
                                    <#--<li>-->
                                        <#--<a href="${base}/mycenter/myprofile"><span>用户中心</span></a>-->
                                    <#--</li>-->
                                    <#--<li>-->
                                        <#--<a href="${base}/user/frontLogout"><span>注销</span></a>-->
                                    <#--</li>-->
                                </ul>
                                </li>
                            </ul>
