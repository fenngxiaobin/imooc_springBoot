                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="dataTables_length" id="datatables-example_length">
                                        ...
                                        <#if "${(errMessage)!}" != ""><font color="green">${(errMessage)!}</font></#if>
                                            <a href="${base}/uploadExcel/modal.xlsx" target="_blank">下载选择题excel模板</a>
                                ...
                                <div class="col-sm-3">
                                    <div id="datatables-example_filter" class="dataTables_filter">
                                        <button data-toggle="modal" data-target="#myModalImport" style="margin-left: -110px;margin-top: -10px;" class=" btn ripple-infinite btn-3d btn-primary" value="primary">
                                            <span><i class="fa fa-plus-square fa-lg"></i>&nbsp;&nbsp;批量导入题库</span>
                                        </button>
                                        <div style="margin-top: 50px" class="modal fade" id="myModalImport" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="${base}/choice/importChoice" method="post" enctype="multipart/form-data">
                                                        <div class="modal-body" style="height:150px;width:400px">
                                                            <label for="name" class="col-sm-5 control-label">选择导入Excel文件</label>
                                                            <div class="col-sm-7">
                                                                <#--<input type="hidden" name="user.id" value="${(userInfo.id)!}" />-->
                                                                <input class="form-input" type="file" name="choiceQuestion" />
                                                            </div>
                                                        </div>
