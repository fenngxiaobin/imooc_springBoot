                                ...
                                <div class="col-sm-4">
                                    <div class="dataTables_length" id="datatables-example_length">
                                        ...
                                        <#if "${(errMessage)!}" != ""><font color="green">${(errMessage)!}</font></#if>
                                            <a href="${base}/uploadExcel/modal_1.xlsx" target="_blank">下载选择题excel模板</a>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                        ...
                                        <div style="margin-top: 50px" class="modal fade" id="myModalImport" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="${base}/tOrF/importTOrF" method="post" enctype="multipart/form-data">
                                                        <div class="modal-body" style="height:150px;width:400px">
                                                            ...
                                                            <#--<input type="hidden" name="user.id" value="${(userInfo.id)!}" />-->
                                                                <input class="form-input" type="file" name="tOrFQuestion" />
                                                            </div>
                                                        </div>
